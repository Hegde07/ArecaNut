...
<table width="1096" height="207" border="1">
  <tr bgcolor="#CC6666">
    ...
    <td width="112"><span class="style6">ACTIVITY</span></td>
  </tr>
  <?php
  session_start();
  $u=$_SESSION['t1'];
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><span class="style9"><?php echo $row['RATE'];?></span></td>
     <td width="94" bgcolor="#FFFFFF"><div align="center" class="style13"><a href="branch_update.php?id=<?php echo $row['BRANCH_NAME'];?>">update</a></div></td>
  </tr>
  <?php } ?>
</table>
